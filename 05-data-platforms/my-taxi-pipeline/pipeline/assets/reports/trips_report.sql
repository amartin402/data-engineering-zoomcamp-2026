...
columns:
  - name: trip_date
    type: date
    description: "Date primary key column for the report"
    primary_key: true
  - name: taxi_type
    type: string
    description: "Taxi type primary key colum for the report"
    primary_key: true
  - name: payment_type
    type: string
    description: "Payment type primary key colum for the report"
    primary_key: true
  - name: trip_count
    type: BIGINT
    description: "Counts the number of trips"
    checks:
      - name: non_negative
