...
>SOLUTION
```
If you'd like to explore Kestra outputs, disable it.
  # - id: purge_files
...
```
 SELECT COUNT(1) AS Cnt
	...
	WHERE filename LIKE 'yellow_tripdata_2020%' AND filename LIKE '%.csv';
```
...
```
 SELECT COUNT(1) AS Cnt
	...
	WHERE filename LIKE 'green_tripdata_2020%' AND filename LIKE '%.csv';
```
